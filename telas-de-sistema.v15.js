...
$(document).ready(function() {
  ...
  $('#letra-zoom').each(function() {
      var texto = $(this).html();
      var dv1 = '<hr id="DV1" />';
      var dply = '<tela_s><bd1></bd1><bd4></bd4><txt>';
      var dply2 = '</txt><bd2 class="x"></bd2><bd3></bd3></tela_s>';
...
.replace(/#display#/g, dply)
.replace(/#display-fim#/g, dply2)
.replace(/<p><tela_s><bd1></bd1><bd4></bd4><txt></txt></tela_s></p>/g, dply)
.replace(/<p><bd2></bd2><bd3></bd3></p>/g, dply2)
